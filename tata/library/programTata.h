...
#define activeButon	2			// 2 second
#define preStart	10			// 10 second to clear fire room of gasoline
#define NrOfRetryers 1			//numbers of retryers 1 = 2 times
#define activeButtonForReset 6
#define RunTime	1800			//30 min
#define TemperaturaMinRacire 40	//40C temperatura de racire minima la care se poate duce la sleep
